...
const coalescersSource = await readFile(new URL("../hooks/agent-session/coalescers.ts", import.meta.url), "utf8");
...
test("message_update deltas are rAF-coalesced into one dispatch per frame", () => {
  ...
  assert.match(coalescersSource, /deltaFrameRef\.current = requestAnimationFrame/);
});
