...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "palette.placeholder": "Search commands, sessions, files…",
    "palette.actions": "Actions",
    "palette.sessions": "Sessions",
    "palette.files": "Files",
    "palette.noResults": "No results",
    "palette.directory": "Directory",
    "running.runningCenter": "Running Tasks",
    "running.noRunning": "No running tasks",
    "running.refresh": "Refresh",
    "running.totalRunning": "Total running: {count}",
    "running.justNow": "just now",
    "running.minutesAgo": "{n}m ago",
    "running.hoursAgo": "{n}h ago",
    "running.daysAgo": "{n}d ago",
    "common.settings": "Settings",
    "appUpdate.releaseNotes": "OMP Web v{version} is available. View release notes",
    ...
    "sidebar.searchNoMatch": "No matching sessions",
    "sidebar.newSessionTitle": "New session in {path}",
    "sidebar.loadingProject": "Loading project…",
    ...
    "sidebar.noProjects": "No projects yet. Open a directory to begin.",
    "sidebar.openDirectory": "Open directory…",
    "sidebar.addProject": "Add project…",
    "sidebar.expandMore": "Expand {count} more",
    "sidebar.collapse": "Collapse",
    "sidebar.projectHeader": "{name} ({count} sessions)",
    ...
    "sidebar.time.minutes": "{n}min",
    "sidebar.time.hours": "{n}h",
    "sidebar.time.days": "{n}d",
    "sidebar.time.months": "{n}mo",
    "sidebar.time.years": "{n}y",
    ...
    "chat.newSessionTarget": "New session · {cwd}",
    ...
    "chat.controls.more": "More",
    "chat.controls.toolPreset": "Tool preset",
    "chat.controls.sound": "Sound",
    "chat.controls.soundOn": "On",
    "chat.controls.soundOff": "Off",
    "chat.shell": "Shell",
    ...
    "chat.queue": "Queue",
    "chat.queueMode": "Queue mode",
    "chat.steering": "Steering",
    "chat.interrupt": "Interrupt",
    "chat.oneAtATime": "One at a time",
    "chat.all": "All",
    "chat.immediate": "Immediate",
    "chat.wait": "Wait",
    ...
    "chat.handoffTitle": "Hand off to a fresh session with a summary",
    "chat.handingOff": "Handing off…",
    "chat.fastMode": "Fast",
    "chat.fastModeOn": "Fast mode on",
    "chat.fastModeOff": "Fast mode off",
    "chat.fastModeInactive": "Fast mode (inactive for current model)",
    ...
    "chat.todos": "Todo list",
    "chat.todoBarRunning": "Running: {task}",
    "chat.todoBarNext": "Next: {task}",
    "chat.todoBarIdle": "Tasks in progress",
    "goal.title": "Goal",
    "goal.objective": "Objective",
    "goal.active": "In progress",
    "goal.paused": "Paused",
    "goal.complete": "Completed",
    "goal.dropped": "Dropped",
    "goal.budgetLimited": "Budget limited",
    "goal.tokensUsed": "{count} tokens used",
    "goal.tokenBudget": "budget {count}",
    "goal.timeUsed": "Elapsed {time}",
    ...
    "usage.empty": "No usage data yet. Start a session to see stats.",
    "usage.tokens": "Tokens",
    "usage.cost": "Cost",
    ...
    "usage.model": "Model",
    "usage.unknownModel": "unknown",
    "usage.close": "Close",
    "usage.error": "Failed to load usage data.",
    ...
    "collab.noSession": "Select a saved session to share it.",
    "collab.generateShare": "Generate share link",
    "collab.sharing": "Sharing…",
    "collab.session": "Session",
    "collab.copy": "Copy",
    "collab.copied": "Copied",
    "collab.liveTitle": "Live collaboration",
    "collab.liveBody": "Start a live session with /collab in the OMP terminal, then share the join link. Guests can watch or prompt; links without a write token are read-only.",
    "collab.webUrl": "Collab web client",
    "collab.joinPlaceholder": "Paste a collab link (e.g. my.omp.sh/abc123.key)",
    "collab.join": "Join",
    "collab.openJoin": "Open in collab web client",
    "subagent.title": "Subagents",
    "subagent.unavailable": "Subagents unavailable",
    "subagent.refresh": "Refresh",
    "subagent.loading": "Loading…",
    "subagent.monitorUnavailable": "Subagent monitor unavailable.",
    "subagent.empty": "No subagents yet. Subagents launched by the task tool will appear here.",
    "subagent.transcript": "Subagent transcript",
    "subagent.back": "Back",
    "subagent.backToSubagentList": "Back to subagent list",
    ...
    "settings.rolesConfigured": "{count} roles configured",
    "settings.roleUnset": "— Unset —",
    "settings.none": "None",
    "settings.credentialSetPlaceholder": "•••••••• (set, leave blank to keep)",
    "settings.credentialUnsetPlaceholder": "Not set",
