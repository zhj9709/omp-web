...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "palette.placeholder": "搜索命令、会话、文件…",
    "palette.actions": "操作",
    "palette.sessions": "会话",
    "palette.files": "文件",
    "palette.noResults": "无结果",
    "palette.directory": "目录",
    "running.runningCenter": "运行中任务",
    "running.noRunning": "无运行中任务",
    "running.refresh": "刷新",
    "running.totalRunning": "共 {count} 个运行中",
    "running.justNow": "刚刚",
    "running.minutesAgo": "{n} 分钟前",
    "running.hoursAgo": "{n} 小时前",
    "running.daysAgo": "{n} 天前",
    "common.settings": "设置",
    "appUpdate.releaseNotes": "OMP Web v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    ...
    "sidebar.viewFlat": "平铺列表",
    "sidebar.searchNoMatch": "没有匹配的会话",
    "sidebar.newSessionTitle": "在 {path} 中新建会话",
    "sidebar.loadingProject": "正在加载项目…",
    "sidebar.refresh": "刷新",
    ...
    "sidebar.noProjects": "暂无项目。打开一个目录开始。",
    "sidebar.openDirectory": "打开目录…",
    "sidebar.addProject": "添加项目…",
    "sidebar.expandMore": "展开 {count} 条",
    "sidebar.collapse": "收起",
    "sidebar.projectHeader": "{name}（{count} 个会话）",
    ...
    "sidebar.time.now": "刚刚",
    "sidebar.time.minutes": "{n}分钟",
    "sidebar.time.hours": "{n}小时",
    "sidebar.time.days": "{n}天",
    "sidebar.time.months": "{n}个月",
    "sidebar.time.years": "{n}年",
    ...
    "chat.controls.more": "更多",
    "chat.controls.toolPreset": "工具预设",
    "chat.controls.sound": "提示音",
    "chat.controls.soundOn": "开",
    "chat.controls.soundOff": "关",
    "chat.shell": "Shell",
    ...
    "chat.compact": "压缩",
    "chat.handoff": "交接",
    "chat.handoffTitle": "生成交接摘要并转入新会话",
    "chat.handingOff": "正在交接…",
    "chat.fastMode": "快速",
    "chat.fastModeOn": "快速模式已开启",
    "chat.fastModeOff": "快速模式已关闭",
    "chat.fastModeInactive": "快速模式（当前模型不可用）",
    ...
    "chat.todos": "任务清单",
    "chat.todoBarRunning": "正在执行 {task}",
    "chat.todoBarNext": "接下来 {task}",
    "chat.todoBarIdle": "任务进行中",
    "goal.title": "目标",
    "goal.objective": "目标内容",
    "goal.active": "进行中",
    "goal.paused": "已暂停",
    "goal.complete": "已完成",
    "goal.dropped": "已放弃",
    "goal.budgetLimited": "预算受限",
    "goal.tokensUsed": "已用 {count} tokens",
    "goal.tokenBudget": "预算 {count}",
    "goal.timeUsed": "耗时 {time}",
    "chat.dormant": "休眠",
    "chat.compacted": "已压缩",
    ...
    "usage.title": "用量仪表盘",
    "usage.loading": "加载中...",
    "usage.empty": "暂无用量数据。开始会话后即可查看统计。",
    "usage.tokens": "Token",
    "usage.cost": "费用",
    "usage.requests": "请求",
    "usage.sessions": "会话",
    ...
    "collab.noSession": "请先选择一个已保存的会话再分享。",
    "collab.generateShare": "生成分享链接",
    "collab.sharing": "正在分享…",
    "collab.session": "会话",
    "collab.copy": "复制",
    "collab.copied": "已复制",
    "collab.liveTitle": "实时协作",
    "collab.liveBody": "在 OMP 终端中使用 /collab 启动实时会话，然后分享加入链接。访客可观看或输入；不含写入令牌的链接为只读。",
    "collab.webUrl": "协作 Web 客户端",
    "collab.joinPlaceholder": "粘贴协作链接（例如 my.omp.sh/abc123.key）",
    "collab.join": "加入",
    "collab.openJoin": "在协作 Web 客户端中打开",
    "subagent.title": "子代理",
    "subagent.unavailable": "子代理不可用",
    "subagent.refresh": "刷新",
    "subagent.loading": "加载中…",
    "subagent.monitorUnavailable": "子代理监控不可用。",
    "subagent.empty": "暂无子代理。task 工具启动的子代理会显示在这里。",
    "subagent.transcript": "子代理转录",
    "subagent.back": "返回",
    "subagent.backToSubagentList": "返回子代理列表",
    ...
    "settings.modelRoles": "模型角色分配",
    "settings.rolesConfigured": "{count} 个角色已配置",
    "settings.roleUnset": "— 未设置 —",
    "settings.none": "无",
    "settings.credentialSetPlaceholder": "••••••••（已设置，留空保持不变）",
    "settings.credentialUnsetPlaceholder": "未设置",
    "settings.clear": "清除",
    "settings.apply": "应用",
